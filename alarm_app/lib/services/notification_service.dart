...
class NotificationService {
  ...
  // Track which alarms have already triggered to prevent duplicates
  ...
  void _checkAndTriggerAlarms() {
    ...
    // Reset triggered alarms when minute changes
    if (_lastCheckedMinute != currentMinute) {
  ...
  Future<void> showAlarmRinging(String title, String alarmId) async {
    ...
    // Use a fixed notification ID based on alarmId to prevent duplicates
